...
<table class="l">
    <thead>
	<tr class="m">
 <th colspan="2">12/31/2016 (Millions of euros)</th>
 <th></th>
 <th></th>
 <th></th>
</tr>
        <tr>
            <th>Public Balance Sheet HeadingsPublic</th>
            <th>Public Balance Sheet</th>
            <th>Insurance companies and real-estate finance companies (1)</th>
            <th>Jointly-controlled entities and other adjustments (2)</th>
            <th>Regulatory balance sheet</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td>Cash and balances with central banks and other demand deposits</td>
            <td>40,039</td>
            <td>-</td>
            <td>59</td>
            <td>40,098</td>
        ...
        <tr>
            <td>Other financial assets designated at fair value through profit or loss</td>
            <td>2,062</td>
            <td>(2,058)</td>
            <td>-</td>
            <td>4</td>
        ...
        <tr>
            <td>Investments in entities accounted for using the equity method</td>
            <td>765</td>
            <td>3,716</td>
            <td>(103)</td>
            <td>4,378</td>
...
<ul class="cita"><li>(1) Balances corresponding to the companies not consolidated for solvency purposes but for accounting purposes</li>

<li>(2) Corresponds to other consolidated adjustments</li></ul>
...
<table class="l">
 ...
 <th></th>
        ...
        <tr>
            ...
            <th>Subject to counterparty credit risk framework</th>
            <th>Subject to the securitization framework</th>
            <th>Subject to the market risk framework</th>
            <th>Not subject to captial requirements or subject to deduction from capital</th>
        </tr>
    </thead>
    <tbody>
        <tr class="b2">
        ...
        <tr>
            <td>Equity refundable on demand</td>
            <td>-</td>
            <td>-</td>
            <td>-</td>
            <td>-</td>
...
<table class="l">
    <thead>
        ...
        <tr>
            <th>&nbsp;</th>
            <th>Total</th>
            <th>Credit risk framework</th>
            <th>Securitization framework</th>
            <th>Counterparty credit risk framework</th>
            <th>Market risk framework</th>
        </tr>
    </thead>
    <tbody>
        <tr class="b2">
...
<ul class="cita"><li>(1) Includes provisions for exposures to credit risk via advanced method. The provisions of the credit risk exposures via standard method amounting to 9,130 million euros are not included</li>

<li>(2) Corresponds to the amount of guarantees used as mitigation techniques with substitution effects on exposure to credit risk via advanced method</li>

<li>(3) Corresponds to the amount of CCF adjustments of credit risk via advanced method</li>

<li>(4) It includes, among other accrual account assets, as well as other risk-free accounts</li></ul>
...
<table class="l">
 ...
 <th></th>
    ...
    <tbody>
        ...
        <tr>
            <td>Assets sold under a purchase agreement</td>
            <td>26,315</td>
            <td>26,169</td>
            <td>382</td>
        </tr>
