...
<table class="l">
    ...
    <tbody>
        <tr>
            <td>Aseguradoras con una participación superior al 10% que no consolidan a nivel de solvencia (Anexo I)</td>
            <td>3.306</td>
        </tr>
        <tr>
            <td>Entidades Financieras con una participación superior al 10% que no consolidan a nivel de solvencia (Anexo I)</td>
            <td>150</td>
        </tr>
        <tr>
            <td>Resto de Sociedades que consolidan a nivel contable pero no a nivel de solvencia (Anexo II)</td>
            <td>411</td>
        </tr>
        <tr class="b2">
            <td>TOTAL</td>
